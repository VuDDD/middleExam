...
public class ReadStudent {
    ...
    public static void main(String[] args) {
        ...
        Thread thread1 = new Thread(() -> {
            students.addAll(parseStudentFromXML("C:\\Users\\ADMIN\\eclipse-workspace\\Giuaki\\srcstudent.xml"));
            latch.countDown();
        });
        ...
        try {
            thread1.join();
            thread2.join();
            writeXML(students, "C:\\Users\\ADMIN\\eclipse-workspace\\Giuaki\\src\\kq.xml");
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
    }
